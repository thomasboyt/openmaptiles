...
SELECT osm_id,
       ...
       NULLIF(is_cycleway, false) AS is_cycleway,
       NULLIF(cycleway_type, '') AS cycleway_type, 
       NULLIF(cycleway_oneway, 0) AS cycleway_oneway, 
       NULLIF(foot, '') AS foot,
...
FROM (
         ...
         SELECT osm_id,
                ...
                NULL AS bicycle,
                NULL::boolean AS is_cycleway,
                NULL AS cycleway_type,
                NULL::int as cycleway_oneway,
                NULL AS foot,
                NULL AS horse,
                NULL AS mtb_scale,
                NULL AS surface,
         ...
         SELECT hl.osm_id,
                ...
                bicycle,
                -- TODO: clean this up
                is_cycleway(hl.highway, bicycle, cycleway, cycleway_left, cycleway_right, cycleway_both) AS "is_cycleway",
                CASE WHEN is_cycleway(hl.highway, bicycle, cycleway, cycleway_left, cycleway_right, cycleway_both) THEN get_cycleway_type(hl.highway, cycleway, cycleway_left, cycleway_right, cycleway_both) END AS cycleway_type,
                CASE WHEN is_cycleway(hl.highway, bicycle, cycleway, cycleway_left, cycleway_right, cycleway_both) THEN get_one_way_cycle_direction(CASE WHEN is_oneway <> 0 THEN is_oneway::int END, oneway_bicycle, cycleway, cycleway_left, cycleway_left_oneway, cycleway_right, cycleway_right_oneway, cycleway_both) END AS cycleway_oneway,
                foot,
                horse,
                mtb_scale,
